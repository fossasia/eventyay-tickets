...
class BankImportJob(models.Model):
    ...
    event = models.ForeignKey('base.Event', null=True, on_delete=models.CASCADE)
    organizer = models.ForeignKey('base.Organizer', null=True, on_delete=models.CASCADE)
...
class BankTransaction(models.Model):
    ...
    order = models.ForeignKey('base.Order', null=True, blank=True, on_delete=models.CASCADE)

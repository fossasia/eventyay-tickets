...
class TicketLayout(LoggedModel):
    event = models.ForeignKey('base.Event', on_delete=models.CASCADE, related_name='ticket_layouts')
...
class TicketLayoutProduct(models.Model):
    ...
    layout = models.ForeignKey('TicketLayout', on_delete=models.CASCADE, related_name='product_assignments')

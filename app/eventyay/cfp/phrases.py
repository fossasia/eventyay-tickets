...
class CfPPhrases(Phrases, app='cfp'):
    ...
    submission_confirmed = _('Your session has been confirmed – we’re looking forward to seeing you!')
    submission_was_confirmed = _('This proposal has already been confirmed – we’re looking forward to seeing you!')

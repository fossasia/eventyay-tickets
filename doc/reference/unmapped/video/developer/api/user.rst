...
Instead of IDs, you can also pass a set of ``eventyay_id`` values::

    => ["user.fetch", 123, {"eventyay_ids": ["DKJ2E", "24"]}]
    <- ["success", 123, {"DKJ2E": {"id": "1234", "eventyay_id": "DKJ2E", "profile": {…}}, "5679": {…}}]

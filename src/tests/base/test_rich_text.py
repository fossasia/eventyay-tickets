...
@pytest.mark.parametrize(
    ...
    [
        # Test link detection
        ('google.com', '<a href="http://google.com" rel="noopener" target="_blank">google.com</a>'),
        # Test abslink_callback
        ('[Call](tel:+12345)', '<a href="tel:+12345" rel="nofollow">Call</a>'),
        ('[Foo](/foo)', '<a href="http://example.com/foo" rel="noopener" target="_blank">Foo</a>'),
        ('mail@example.org', '<a href="mailto:mail@example.org">mail@example.org</a>'),
        # Test truelink_callback
        ('evilsite.com', '<a href="http://evilsite.com" rel="noopener" target="_blank">evilsite.com</a>'),
        ('cool-example.eu', '<a href="http://cool-example.eu" rel="noopener" target="_blank">cool-example.eu</a>'),
        ('<a href="https://evilsite.com">Evil Site</a>', '<a href="https://evilsite.com" rel="noopener" target="_blank">Evil Site</a>'),
        ('<a href="https://evilsite.com">evilsite.com</a>', '<a href="https://evilsite.com" rel="noopener" target="_blank">evilsite.com</a>'),
        ('<a href="https://evilsite.com">goodsite.com</a>', '<a href="https://evilsite.com" rel="noopener" target="_blank">https://evilsite.com</a>'),
        (

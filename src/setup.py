...
#         # celery needs to be upgraded also as per the pretix...
#         # 'celery==4.4.*',
#         'celery==5.2.7',
...
#         'jsonschema',
#         # django-hijact need to be upgraded...
#         'django-hijack>=2.1.10,<2.2.0',
#         # ...
#         'openpyxl==3.0.*',
#         # django-oauth-toolkit==1.2.* need to be upgraded...
#         'django-oauth-toolkit==1.2.*',
#         # .....
#         'oauthlib==3.1.*',

#         # django-phonenumber-field needs to be upgraded....
...
setup(
    ...
    install_requires=[
        ...
        'django-hijack>=2.1.10,<2.2.0',
        'openpyxl==3.0.*',
        'django-oauth-toolkit>=1.6,<2.0',
        'oauthlib==3.1.*',
        'django-phonenumber-field>=5.0,<6.0',
        'phonenumberslite==8.11.*',
        'python-bidi==0.4.*',  # Support for Arabic in reportlab
        'arabic-reshaper==2.0.15',  # Support for Arabic in reportlab
        'packaging',

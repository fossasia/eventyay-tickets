...
DEFAULT_SETTINGS = {
    'customer_accounts': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                "Allow your attendees to sign up an account.")
        )
    },
    'customer_accounts_native': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("If this option is disabled, attendees will need to use Single Sign-On (SSO) to log in."),
    ...
    'display_net_prices': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                "Regardless of your selection, the cart will display gross prices as this is the final amount to be paid."),
    ...
    'attendee_emails_required': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("Require attendees to fill in individual e-mail addresses for all admission tickets. See the "
    ...
    'invoice_address_custom_field': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("If you want to add a custom text field, such as a country-specific registration number, to your invoice address form, please enter the label here. This label will be used both for prompting the user to input their details and for displaying the value on the invoice. The field will be optional.")
        )
    },
    ...
    'invoice_numbers_counter_length': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                "The part of your invoice number after your prefix will be filled up with leading zeros up to this length, e.g. INV-001 or INV-00001."),
        )
    },
    ...
    'payment_pending_hidden': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("The payment instructions panel will still be shown to the primary attendee, but no indication "
    ...
    'invoice_reissue_after_modify': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("If attendees change their invoice address on an existing order, the invoice will "
    ...
    'region': {
        ...
        'form_kwargs': lambda: dict(
            label=_('Region'),
            help_text=_('Will be used to determine date and time formatting as well as default country for attendee '
    ...
    'event_list_type': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                'If your event series has more than 50 dates in the future, only the month or week calendar can be used.')
        ),
    },
    ...
    'cancel_allow_user_paid_adjust_fees_step': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('By default, attendees can choose an arbitrary amount for you to keep. If you set this to e.g. '
...
Your {organizer} team"""))
    ...
    'attendee_data_explanation_text': {
        ...
        'form_kwargs': dict(
            ...
            widget_kwargs={'attrs': {'rows': '2'}},
            help_text=_(
                "This text will be shown above the questions asked for every admission product. You can use it e.g. to explain "
    ...
    'checkout_success_text': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                "This message will be shown after an order has been created successfully. It will be shown in additional "
                "to the default text."),
            widget_kwargs={'attrs': {'rows': '2'}},
            widget=I18nTextarea
        )
    ...
    'privacy_policy': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("This should link to a section of your website that clearly "

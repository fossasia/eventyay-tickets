...
DEFAULT_SETTINGS = {
    ...
    'display_net_prices': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('Regardless of your selection, the cart will display gross prices as this is the final amount to be paid.'),
        ),
    },
    ...
    'invoice_eu_currencies': {
        ...
        'serializer_class': serializers.BooleanField,
        'form_kwargs': dict(
            label=_('On invoices from one EU country to another EU country with a different currency, display the tax amounts in both currencies.'),
        ),
    },
    ...
    'invoice_address_vatid': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('This option is only applicable if an invoice address is requested. The VAT ID field will not be required.'),
            widget=forms.CheckboxInput(attrs={'data-checkbox-dependency': '#id_invoice_address_asked'}),
        ),
    },
    ...
    'invoice_show_payments': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('If an invoice has already been paid partially, this option will add the paid and pending amount to the invoice.'),
        ),
    },
    ...
    'payment_explanation': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('This text will be shown above the payment options. You can explain the choices to the user here, if you want.'),
        ),
    },
    'payment_term_mode': {
        'default': 'days',
    ...
    'invoice_additional_text': {
        ...
        'form_kwargs': dict(
            ...
            widget_kwargs={
                'attrs': {
                    'rows': 3,
                    'placeholder': _('e.g. Thank you for your purchase! You can find more information on the event at ...'),
                }
            },
    ...
    'invoice_footer_text': {
        ...
        'form_kwargs': dict(
            ...
            widget_kwargs={
                'attrs': {
                    'rows': 5,
                    'placeholder': _('e.g. your bank details, legal details like your VAT ID, registration numbers, etc.'),
                }
            },
            label=_('Footer'),
    ...
    'mail_prefix': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                'This will be prepended to the subject of all outgoing emails, formatted as [prefix]. Choose, for example, a short form of your event name.'
            ),
        ),
    },
    ...
    'mail_from_name': {
        ...
        'form_kwargs': dict(
            label=_('Sender name'),
            help_text=_('Sender name used in conjunction with the sender address for outgoing emails. Defaults to your event name.'),
        ),
    },
...
Your {event} team"""
    ...
    'banner_text': {
        ...
        'form_kwargs': dict(
            ...
            widget=I18nTextarea,
            widget_kwargs={'attrs': {'rows': '2'}},
            help_text=_('This text will be shown above every page of your shop. Please only use this for very important messages.'),
        ),
    },
    'banner_text_bottom': {
        'default': '',
        ...
        'form_kwargs': dict(
            ...
            widget=I18nTextarea,
            widget_kwargs={'attrs': {'rows': '2'}},
            help_text=_('This text will be shown below every page of your shop. Please only use this for very important messages.'),
        ),
    },
    'voucher_explanation_text': {
        ...
        'form_kwargs': dict(
            ...
            widget=I18nTextarea,
            widget_kwargs={'attrs': {'rows': '2'}},
            help_text=_('This text will be shown next to the input for a voucher code. You can use it e.g. to explain how to obtain a voucher code.'),
        ),
    },
    ...
    'checkout_success_text': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('This message will be shown after an order has been created successfully. It will be shown in additionalto the default text.'),
            widget_kwargs={'attrs': {'rows': '2'}},
            widget=I18nTextarea,
        ),
    },
    ...
    'giftcard_length': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                'The system generates by default {}-character long gift card codes. However, if a different length is required, it can be set here.'.format(
    ...
    'privacy_policy': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('This should link to a section of your website that clearly explains how you collect, manage, and use the gathered data.'),
            widget=I18nTextInput,
        ),
    ...
    [
        ...
        (
            'family_given',
            {
                ...
                'concatenation': lambda d: ' '.join(str(p) for p in [d.get('family_name', ''), d.get('given_name', '')] if p),
                'sample': {
                    'given_name': pgettext_lazy('person_name_sample', 'John'),
                    'family_name': pgettext_lazy('person_name_sample', 'Doe'),
        ...
        (
            'family_comma_given',
            {
                ...
                'concatenation': lambda d: (
                    str(d.get('family_name', '')) + str((', ' if d.get('family_name') and d.get('given_name') else '')) + str(d.get('given_name', ''))
                ),
                'sample': {
                    'given_name': pgettext_lazy('person_name_sample', 'John'),
                    'family_name': pgettext_lazy('person_name_sample', 'Doe'),
        ...
        (
            'salutation_given_family',
            {
                ...
                'concatenation': lambda d: ' '.join(str(p) for p in (d.get(key, '') for key in ['given_name', 'family_name']) if p),
                'sample': {
        ...
        (
            'salutation_title_given_family',
            {
                ...
                'concatenation': lambda d: ' '.join(str(p) for p in (d.get(key, '') for key in ['title', 'given_name', 'family_name']) if p),
                'sample': {
                    'salutation': pgettext_lazy('person_name_sample', 'Mr'),
                    'title': pgettext_lazy('person_name_sample', 'Dr'),
                    'given_name': pgettext_lazy('person_name_sample', 'John'),

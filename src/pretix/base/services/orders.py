...
def _create_order(
    ...
    with transaction.atomic():
        ...
        order = Order(
            ...
            total=total,
            testmode=True
            if sales_channel.testmode_supported and event.testmode
            else False,
...
def _order_placed_email(
    ...
    try:
        order.send_mail(
            ...
            log_entry,
            invoices=[invoice]
            if invoice and event.settings.invoice_email_attachment
            else [],
            attach_tickets=True,
            ...
            if isinstance(op, self.ItemOperation):
                self.order.log_action(
                    ...
                    data={
                        ...
                        'old_variation': op.position.variation.pk
                ...
                self.order.log_action(
                    ...
                    data={
                        ...
                        'old_seat_id': op.position.seat.pk
                        if op.position.seat
                        else None,
                ...
                for opa in op.position.addons.all():
                    self.order.log_action(
                        ...
                        data={
                            ...
                            'old_variation': opa.variation.pk
                            if opa.variation
                            else None,

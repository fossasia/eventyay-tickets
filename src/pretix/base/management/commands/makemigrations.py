...
However, Eventyay only supports PostgreSQL and SQLite and we can be pretty
...
IGNORED_ATTRS = [
    ...
    (models.Field, 'blank', [models.DateField, models.DateTimeField, models.AutoField, models.NullBooleanField, models.TimeField]),

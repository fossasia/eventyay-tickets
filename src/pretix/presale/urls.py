...
frame_wrapped_urls = [
    url(
        r'^cart/remove$',
        pretix.presale.views.cart.CartRemove.as_view(),
        name='event.cart.remove',
    ),
    url(
        r'^cart/voucher$',
        pretix.presale.views.cart.CartApplyVoucher.as_view(),
        name='event.cart.voucher',
    ),
    url(
        r'^cart/clear$',
        pretix.presale.views.cart.CartClear.as_view(),
    ...
    url(
        r'^checkout/start$',
        pretix.presale.views.checkout.CheckoutView.as_view(),
    ...
    url(
        r'^redeem/?$',
        pretix.presale.views.cart.RedeemView.as_view(),
        name='event.redeem',
    ),
    url(
        r'^online-video/join$',
        pretix.presale.views.event.JoinOnlineVideoView.as_view(),
        name='event.onlinevideo.join',
    ),
    url(
        r'^seatingframe/$',
        pretix.presale.views.event.SeatingPlanView.as_view(),
    ...
    url(
        r'^(?P<subevent>[0-9]+)/$',
        pretix.presale.views.event.EventIndex.as_view(),
        name='event.index',
    ),
    url(
        r'^waitinglist',
        pretix.presale.views.waiting.WaitingView.as_view(),
...
event_patterns = [
    ...
    url(
        r'^cart/add$',
        pretix.presale.views.cart.CartAdd.as_view(),
        name='event.cart.add',
    ),
    url(
    ...
    url(
        ...
        pretix.presale.views.user.UnlockHashView.as_view(),
        name='event.payment.unlock',
    ),
    url(
        r'resend/$',
        pretix.presale.views.user.ResendLinkView.as_view(),
    ...
    url(
        ...
        pretix.presale.views.order.OrderDetails.as_view(),
        name='event.order',
    ),
    url(
    ...
    url(
        ...
        pretix.presale.views.widget.WidgetAPIProductList.as_view(),
        name='event.widget.productlist',
    ),
    url(
        r'^widget/v1.css$',
        pretix.presale.views.widget.widget_css,
...
organizer_patterns = [
    url(
        r'^$',
        pretix.presale.views.organizer.OrganizerIndex.as_view(),
...
locale_patterns = [
    url(
        r'^locale/set$',
        pretix.presale.views.locale.LocaleSet.as_view(),
        name='locale.set',
    ),
    url(r'^robots.txt$', pretix.presale.views.robots.robots_txt, name='robots.txt'),
    url(
        r'^browserconfig.xml$',
        pretix.presale.views.theme.browserconfig_xml,
        name='browserconfig.xml',
    ),
    url(
        r'^site.webmanifest$',
        pretix.presale.views.theme.webmanifest,
        name='site.webmanifest',
    ),
    url(
        r'^widget/v1\.(?P<lang>[a-zA-Z0-9_\-]+)\.js$',
        pretix.presale.views.widget.widget_js,
        name='widget.js',
    ),
]

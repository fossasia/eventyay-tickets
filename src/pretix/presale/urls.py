...
frame_wrapped_urls = [
    path('cart/remove', pretix.presale.views.cart.CartRemove.as_view(), name='event.cart.remove'),
    path('cart/voucher', pretix.presale.views.cart.CartApplyVoucher.as_view(), name='event.cart.voucher'),
    path('cart/clear', pretix.presale.views.cart.CartClear.as_view(), name='event.cart.clear'),
    path('cart/answer/<str:answer>/',
        pretix.presale.views.cart.AnswerDownload.as_view(),
        name='event.cart.download.answer'),
    path('checkout/start', pretix.presale.views.checkout.CheckoutView.as_view(), name='event.checkout.start'),
    path('checkout/<str:step>/', pretix.presale.views.checkout.CheckoutView.as_view(),
        name='event.checkout'),
    re_path(r'^redeem/?$', pretix.presale.views.cart.RedeemView.as_view(),
        name='event.redeem'),
    path('seatingframe/', pretix.presale.views.event.SeatingPlanView.as_view(),
        name='event.seatingplan'),
    path('<int:subevent>/seatingframe/', pretix.presale.views.event.SeatingPlanView.as_view(),
        name='event.seatingplan'),
    path('<int:subevent>/', pretix.presale.views.event.EventIndex.as_view(), name='event.index'),
    re_path(r'^waitinglist', pretix.presale.views.waiting.WaitingView.as_view(), name='event.waitinglist'),
    path('', pretix.presale.views.event.EventIndex.as_view(), name='event.index'),
]
event_patterns = [
    ...
    path('cart/add', pretix.presale.views.cart.CartAdd.as_view(), name='event.cart.add'),
    ...
    path('resend/', pretix.presale.views.user.ResendLinkView.as_view(), name='event.resend_link'),
    ...
    path('ical/<int:subevent>/',
        pretix.presale.views.event.EventIcalDownload.as_view(),
        name='event.ical.download'),
    path('auth/', pretix.presale.views.event.EventAuth.as_view(), name='event.auth'),

    path('widget/product_list', pretix.presale.views.widget.WidgetAPIProductList.as_view(),
        name='event.widget.productlist'),
    re_path(r'^widget/v1.css$', pretix.presale.views.widget.widget_css, name='event.widget.css'),
    path('<int:subevent>/widget/product_list', pretix.presale.views.widget.WidgetAPIProductList.as_view(),
        name='event.widget.productlist'),
]

organizer_patterns = [
    path('', pretix.presale.views.organizer.OrganizerIndex.as_view(), name='organizer.index'),
    path('events/ical/',
...
locale_patterns = [
    path('locale/set', pretix.presale.views.locale.LocaleSet.as_view(), name='locale.set'),

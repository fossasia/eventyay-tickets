...
def generate_invoice_pdf(billing_invoice, organizer_billing_info):
    ...
    title_style = ParagraphStyle(name='TitleStyle', fontSize=16, alignment=2,
                                 textColor=colors.HexColor("#333333"))
    body_text_style = ParagraphStyle(name='BodyTextStyle', fontSize=10, alignment=2,
                                     textColor=colors.HexColor("#333333"))  # Uniform font size for other text
    header_style = ParagraphStyle(name='HeaderStyle', fontSize=10, alignment=0, textColor=colors.HexColor("#27aae1"))
    row_header_style = ParagraphStyle(name='HeaderStyle', fontSize=10, alignment=0,
                                      textColor=colors.HexColor("#ffffff"))
    bold_style = ParagraphStyle(name='BoldStyle', fontSize=10, leading=12, fontName="Helvetica-Bold", alignment=0)
    ...
    elements.append(HRFlowable(width="100%", thickness=1, color=colors.HexColor("#27aae1")))
    elements.append(Spacer(1, 0.2 * inch))
    ...
    item_data = [
        [Paragraph("#", row_header_style), Paragraph("DESCRIPTION", row_header_style),
    ...
    return FileResponse(buffer, as_attachment=True, filename=f"Invoice_{billing_invoice.id}.pdf")

...
urlpatterns = [
    ...
    url(r'^global/information/$', global_settings.AdminiInformationView.as_view(), name='global.information'),
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/sso_providers$', organizer.SSOProvidersView.as_view(),
            name='organizer.sso.providers'),
    url(r'^organizer/(?P<organizer>[^/]+)/sso_provider/add$', organizer.CreateProviderView.as_view(),
            name='organizer.ssoprovider.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/sso_provider/(?P<provider>[^/]+)/edit$',
            organizer.UpdateProviderView.as_view(),
            name='organizer.ssoprovider.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/sso_provider/(?P<provider>[^/]+)/delete$',
            organizer.DeleteProviderView.as_view(),
            name='organizer.ssoprovider.delete'),
    url(r'^organizer/(?P<organizer>[^/]+)/ssoclients$', organizer.SSOClientsView.as_view(),
            name='organizer.sso.clients'),
    url(r'^organizer/(?P<organizer>[^/]+)/ssoclient/add$', organizer.CreateClientView.as_view(),
            name='organizer.sso.client.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/ssoclient/(?P<client>[^/]+)/edit$',
            organizer.UpdateClientView.as_view(),
            name='organizer.sso.client.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/ssoclient/(?P<client>[^/]+)/delete$',
            organizer.DeleteClientView.as_view(),
            name='organizer.sso.client.delete'),

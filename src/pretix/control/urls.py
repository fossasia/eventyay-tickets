    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^organizers/$',
                    admin.OrganizerList.as_view(),
                    name='admin.organizers',
                ),
                url(r'^events/$', admin.AdminEventList.as_view(), name='admin.events'),
                url(
                    r'^task_management',
                    admin.TaskList.as_view(),
                    name='admin.task_management',
                ),
                url(
                    r'^sudo/(?P<id>\d+)/$',
                    user.EditStaffSession.as_view(),
                    name='admin.user.sudo.edit',
                ),
                url(
                    r'^sudo/sessions/$',
                    user.StaffSessionList.as_view(),
                    name='admin.user.sudo.list',
                ),
                url(r'^users/$', users.UserListView.as_view(), name='admin.users'),
                url(
                    r'^users/select2$',
                    typeahead.users_select2,
                    name='admin.users.select2',
                ),
                url(
                    r'^users/add$',
                ...
                url(
                    r'^users/(?P<id>\d+)/$',
                    users.UserEditView.as_view(),
                    name='admin.users.edit',
                ),
                url(
                    r'^users/(?P<id>\d+)/reset$',
                    users.UserResetView.as_view(),
                ...
                url(
                    r'^vouchers/add$',
                    admin.VoucherCreate.as_view(),
                    name='admin.vouchers.add',
                ),
                url(
                    r'^vouchers/(?P<voucher>\d+)/$',
                    admin.VoucherUpdate.as_view(),
                    name='admin.voucher',
                ),
                url(
                    r'^vouchers/(?P<voucher>\d+)/delete$',
                    admin.VoucherDelete.as_view(),
                    name='admin.voucher.delete',
                ),
                url(
                    r'^global/sso/$',
                    global_settings.SSOView.as_view(),
                ...
                url(
                    r'^pages/(?P<id>\d+)/edit$',
                    pages.PageUpdate.as_view(),
                    name='admin.pages.edit',
                ),
                url(
                    r'^pages/(?P<id>\d+)/delete$',
                    pages.PageDelete.as_view(),

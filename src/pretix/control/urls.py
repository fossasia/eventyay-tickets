...
urlpatterns = [
    ...
    url(r'^admin/', include([
        ...
        url(r'^global/billing_validation/$', RedirectView.as_view(pattern_name='control:admin.global.settings.billing_validation',permanent=True),
        ...
        url(r'^settings/$', RedirectView.as_view(pattern_name='control:admin.global.settings.basics', permanent=False),
            name='admin.global.settings'),
        url(r'^settings/basics/$', global_settings.GlobalSettingsView.as_view(), name='admin.global.settings.basics'),
        url(r'^settings/localization/$', global_settings.GlobalSettingsLocalizationView.as_view(), name='admin.global.settings.localization'),
        ...
        url(r'^settings/billing_validation/$', global_settings.GlobalSettingsBillingValidationView.as_view(), 
            name='admin.global.settings.billing_validation'),

...
urlpatterns = [
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/customers$', organizer_views.customer_view.CustomerListView.as_view(),
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/customer/(?P<customer>[^/]+)/$',
        organizer_views.customer_view.CustomerDetailView.as_view(), name='organizer.customer'),
    url(r'^organizer/(?P<organizer>[^/]+)/customer/(?P<customer>[^/]+)/edit$',
        organizer_views.customer_view.CustomerUpdateView.as_view(), name='organizer.customer.edit'),

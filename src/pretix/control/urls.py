    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^categories/(?P<category>\d+)/down$', item.category_move_down, name='event.items.categories.down'
                ),
                url(
    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^settings/$',
                    RedirectView.as_view(pattern_name='control:admin.global.settings.basics', permanent=False),
                    name='admin.global.settings',
                ),
                url(
                    r'^settings/basics/$',
                    global_settings.GlobalSettingsView.as_view(),
                    name='admin.global.settings.basics',
                ),
                url(
                    r'^settings/localization/$',
                    global_settings.GlobalSettingsLocalizationView.as_view(),
                    name='admin.global.settings.localization',
                ),
                url(
                    r'^settings/email/$',
                    global_settings.GlobalSettingsEmailView.as_view(),
                    name='admin.global.settings.email',
                ),
                url(
                    r'^settings/payment_gateways/$',
                    global_settings.GlobalSettingsPaymentGatewaysView.as_view(),
                    name='admin.global.settings.payment_gateways',
                ),
                url(
                    r'^settings/ticket_fees/$',
                    global_settings.GlobalSettingsTicketFeesView.as_view(),
                    name='admin.global.settings.ticket_fees',
                ),
                url(
                    r'^settings/maps/$',
                    global_settings.GlobalSettingsMapsView.as_view(),
                    name='admin.global.settings.maps',
                ),
            ]
        ),
    ),

...
def pretixcontrol_logentry_display(sender: Event, logentry: LogEntry, **kwargs):
    plains = {
        ...
        'eventyay.organizer.footerlinks.changed': _('The footer links have been changed.'),
        ...
        'eventyay.customer.password.resetrequested': _('Customer request a new password.'),
        ...
        'eventyay.event.footerlinks.changed': _('The footer links have been changed.'),

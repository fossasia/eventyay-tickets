...
class BillingSettingsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        selected_languages = [(code, name) for code, name in settings.LANGUAGES if code in self.organizer.settings.locales]
        ...
        if instance:
            ...
            if commit:
                stripe_customer = create_stripe_customer(
                    email=self.cleaned_data.get('primary_contact_email'), name=self.cleaned_data.get('primary_contact_name')
                )

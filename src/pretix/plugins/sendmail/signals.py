            ...
            "children": [
                {
                    ...
                    "active": (
                        url.namespace == "plugins:sendmail" and url.url_name == "send"
                    ),
                },
                {
                    ...
                    "active": (
                        url.namespace == "plugins:sendmail"
...
def pretixcontrol_logentry_display(sender, logentry, **kwargs):
    plains = {
        ...
        "pretix.plugins.sendmail.order.email.sent": _(
            "The order received a mass email."
        ),
        "pretix.plugins.sendmail.order.email.sent.attendee": _(
            "A ticket holder of this order received a mass email."
        ),
    }

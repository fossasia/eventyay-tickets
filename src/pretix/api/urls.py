...
urlpatterns = [
    ...
    url(r'^organizers/(?P<organizer>[^/]+)/settings/$', organizer.OrganizerSettingsView.as_view(), name='organizer.settings'),
    url(r'^organizers/(?P<organizer>[^/]+)/giftcards/(?P<giftcard>[^/]+)/', include(giftcard_router.urls)),
    url(r'^organizers/(?P<organizer>[^/]+)/events/(?P<event>[^/]+)/settings/$', event.EventSettingsView.as_view(), name='event.settings'),
    ...
    url(r'^organizers/(?P<organizer>[^/]+)/events/(?P<event>[^/]+)/questions/(?P<question>[^/]+)/', include(question_router.urls)),
    url(r'^organizers/(?P<organizer>[^/]+)/events/(?P<event>[^/]+)/checkinlists/(?P<list>[^/]+)/', include(checkinlist_router.urls)),
    url(r'^organizers/(?P<organizer>[^/]+)/checkin/redeem/$', checkin.CheckinRedeemView.as_view(), name='checkin.redeem'),
    ...
    url(r'(?P<organizer>[^/]+)/(?P<event>[^/]+)/schedule-public', event.talk_schedule_public, name='event.schedule-public'),
    url(r'(?P<organizer>[^/]+)/(?P<event>[^/]+)/ticket-check', event.CustomerOrderCheckView.as_view(), name='event.ticket-check'),
]

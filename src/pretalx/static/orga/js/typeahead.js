$(() => {
    $("#nav-search-wrapper").on("shown.bs.collapse shown.bs.dropdown", () =>
    ...
    $("[data-event-typeahead]").each(function () {
        ...
        function showLoadIndicator() {
            ...
            $container
                .find("ul")
                .append(
                    "<li class='loading'><span class='fa fa-4x fa-cog fa-spin'></span></li>",
                )
        ...
        $query.on("change", function () {
            ...
            $.getJSON(
                $container.attr("data-source") +
                    ...
                    (typeof $container.attr("data-organiser") !== "undefined"
                        ? "&organiser=" + $container.attr("data-organiser")
                        : ""),
                function (data) {

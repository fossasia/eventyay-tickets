            ...
            $.getJSON(
                ...
                function (data) {
                    ...
                    $.each(data.results, function (i, res) {
                        $container.append(
                            $("<li>").append(
                                $("<a>").attr("href", res.url).addClass("event-text").append(
                                        $("<span>").addClass("event-name").append($("<div>").text(res.name).html())
                                    ).append(
                                        $("<span>").addClass("event-organiser").append(
                                            $("<span>").addClass("fa fa-users fa-fw")
                                        ).append(" ").append($("<div>").text(res.organiser).html())
                                    ).append(
                                        $("<span>").addClass("event-date").append(

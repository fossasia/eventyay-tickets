...
hierarkey.add_default('mail_text_reset', LazyI18nString.from_gettext(ugettext_noop("""Hello {name},
...
hierarkey.add_default('mail_text_new_submission', LazyI18nString.from_gettext(ugettext_noop("""Hi,
...
hierarkey.add_default('mail_text_event_created', LazyI18nString.from_gettext(ugettext_noop("""Hi,
...
""")), LazyI18nString)
hierarkey.add_default('mail_text_cfp_closed', LazyI18nString.from_gettext(ugettext_noop("""Hi,
...
""")), LazyI18nString)
hierarkey.add_default('mail_text_event_over', LazyI18nString.from_gettext(ugettext_noop("""Hi,

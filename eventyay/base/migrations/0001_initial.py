# Generated by Django 5.1.9 on 2025-07-28 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rooms', to='eventyaybase.event')),
            ],
            options={
                'ordering': ('position',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='schedules', to='eventyaybase.event')),
            ],
            options={
                'ordering': ('-published',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='availabilities', to='eventyaybase.event')),
                ('room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='availabilities', to='eventyaybase.room')),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='availabilities', to='eventyaybase.speakerprofile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(blank=True, help_text='The room this talk is scheduled in, if any', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='talks', to='eventyaybase.room', verbose_name='Room')),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='talks', to='eventyaybase.schedule')),
                ('submission', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='slots', to='eventyaybase.submission')),
            ],
            options={
                'ordering': ('start',),
            },

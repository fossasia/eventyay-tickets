# Generated by Django 5.1.11 on 2025-07-28 16:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='organizers',
            field=models.ManyToManyField(to='eventyaybase.organizer'),
        ),
        migrations.AddField(
            model_name='oauthaccesstoken',
            name='user',
        ...
        migrations.AddField(
            model_name='webhook',
            name='limit_events',
            field=models.ManyToManyField(blank=True, to='eventyaybase.event', verbose_name='Limit to events'),
        ),
        migrations.AddField(
            model_name='webhook',
            name='organizer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='webhooks', to='eventyaybase.organizer'),
        ),
        migrations.AddField(
            model_name='webhookcall',
            name='webhook',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='calls', to='eventyayapi.webhook'),
        ),
        migrations.AddField(
            model_name='webhookeventlistener',
            name='webhook',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listeners', to='eventyayapi.webhook'),
        ),

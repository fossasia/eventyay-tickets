...
INSTALLED_APPS = [
    ...
    "eventyay.base.api.ApiConfig",
    "eventyay.api",
    "eventyay.base.live.LiveConfig",
    "eventyay.base.analytics.graphs.GraphsConfig",
    "eventyay.base.data.importers.ImportersConfig",
    "eventyay.base.storage.StorageConfig",
    "eventyay.base.social.SocialConfig",
    "eventyay.base.integrations.zoom.ZoomConfig",
    "eventyay.base.control.ControlConfig",
    "eventyay.base",
    "eventyay.helpers",
...
MIDDLEWARE = [
    ...
    "eventyay.base.control.middleware.SessionMiddleware",
    "eventyay.base.control.middleware.AuthenticationMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "eventyay.base.control.middleware.MessageMiddleware",
